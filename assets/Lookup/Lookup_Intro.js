export default {
    "default": {
      		"source" : ["",
					           ...
					           "Canadian authorities ignoring hazards of costly refugee system"],

			 "format" : ["header", "tag", "frame", "body", "body"],
    },
    ...
    [
     {"source" : ["Canadian authorities ignoring hazards of costly refugee system",
                 ...
                 "One distraught mother, who asked not to be identified for fear of reprisals, told the Metro "+
     ...
     {"source" : ["Muslims celebrate ISIS-inspired shooting in Toronto",
			 ...
			 "format" : ["header", "tag", "frame", "tag", "body"],
     },
     {"source" : ["Politicians call for end to multiculturalism",
 			 				  "11/11/2019 - Professional Writer",

							   require('../art/intro/intro_image_1_comic.png'),

                 "A populist. /Submitted",

                 "At a recent election rally, the newly formed Populist Party leader promised to accept"+
