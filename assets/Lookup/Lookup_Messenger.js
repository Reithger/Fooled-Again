export default {
    ...
    "script" : [
      ...
      { source : "source_4", text : "It is easy to check the social media posts of public figures. Make sure to look for the verified symbol so you know it is not an imposter."},
      ...
      { source : "player", image : require('../art/intro/intro_image_3_comic.png')},
      ...
      { source : "player", text : "I gotta go write about this on the blog and reveal the truth about these stories, thanks folks!"},
      { source : "source_0", text : "Hey, before you go, what blog app do you use again? With the goofy symbol? I want to make something about cats."},
      { source : "player", image : require('../art/meta/blog.png')},
      { source : "player", text : "That one? It's 'My Live Space Journal', I like it well enough; it even lets you design the blog yourself!"},
      { source : "player", text : "Seeya!"},
