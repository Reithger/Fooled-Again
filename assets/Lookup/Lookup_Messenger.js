    ...
    "script" : {
      ...
      intro : {
        content : [
          ...
          choice : ["How can I verify that refugee kids attacked their classmates?", "Ok, so did anyone else hear about refugee kids attacking their classmates?"],
          goto : ["blue1", "red1"]},
        ]
      },
      blue1 : {
        content : [
          ...
          {source : "source_7", text : "Can u imagine? “Extra! Extra! We F-‘d up!”",
          choice : ["How could I confirm that the refugee kid sent a threatening post in Arabic to hurt his classmates?", "Ok, so did anyone else hear about refugee kids attacking their classmates?"],
          goto : ["blue2", "red2"]},
        ],
      },
      blue2 : {
        content : [
          ...
          {source : "source_0", text : "Let’s hope the people who created that translator don’t get put in charge of making alien contact. “We come in peace!”  *Blows up Earth*",
          choice : ["That “culture of violence’ stuff is pretty disturbing. Who is saying that? What’s their deal?", "Is there proof that some academic really said that stuff linking immigrants and violence?"],
          goto : ["blue3", "red2"]},
          ],
        },
      red1 : {
      ...
      blue3 : {
        content : [
          ...
          {source : "source_1", text : "Yeah, today’s racists use dog whistles - code words that they and their followers will know like “Those people” or “Old Stock Canadians.”",
          choice : ["There must be a way to confirm whether Canada is seeking a million immigrants.", "The news story says Canada is asking a bunch of African countries for a million immigrants. I feel like I’ve heard that before."],
          goto : ["blue4", "red3"]},
          ],
        },
      red2 : {
      ...
      blue4 : {
        content : [
          ...
          {source : "source_7", text : "What if *we’re* actually the ones on the underneath and there’s a much better world on the other side?",
          choice : ["What is the evidence for the story about the refugees slaughtering animals in the hotel?", "Is there a verified source for that story about the refugees slaughtering animals in the hotel?"],
          goto : ["blue5", "red4"]},
          ],
        },
      red3 : {
      ...
      blue5 : {
        content : [
          ...
          "and why bad journalists give all journalists a bad name.",
          choice : ["Where can I find more information about whether someone tried to burn down the hotel where the refugees are staying?", "Did someone really try to burn down the hotel where the refugees are staying?"],
          goto : ["blue6", "red5"]},
          ],
        },
      red4 : {
          ...
          {source : "source_6", text : "Your moms.",
          choice : ["Where can I find more information about whether someone tried to burn down the hotel where the refugees are staying?", "Did someone really try to burn down the hotel where the refugees are staying?"],
          goto : ["blue6", "red5"]},
      	],
      	},
      blue6 : {
        content : [
          ...
          {source : "source_3", text : "I hope whoever it was gets the help they so desperately need.",
          choice : ["Is this a legit photo of Muslims celebrating the deadly shooting in Metro?", "Is there really photo evidence of Muslims celebrating the deadly shooting in Metro?"],
          goto : ["blue7", "red6"]},
          ],
        },
      red5 : {
          ...
          "Good thing whoever did it was too stupid to know how set a serious fire.",
          choice : ["Is this a legit photo of Muslims celebrating the deadly shooting in Metro?", "Is there really photo evidence of Muslims celebrating the deadly shooting in Metro?"],
          goto : ["blue7", "red6"]},
      	],
      	},
      blue7 : {
        content : [
          ...
          {source : "source_1", text : "Oh you have no idea how big a deal cricket is outside of North America! It’s huge!",
          choice : ["How can I find out about a political party’s platform?", "So is some political party promising to reduce the number of refugees in Canada, repeal multiculturalism and introduce a values test for new immigrants?"],
          goto : ["blue8", "red7"]},
          ],
        },
      red6 : {
          ...
          "are debunking it. Unfortunately the debunk story never gets shared as much as the fake one.",
          choice : ["How can I find out about a political party’s platform?", "So is some political party promising to reduce the number of refugees in Canada, repeal multiculturalism and introduce a values test for new immigrants?"],
          goto : ["blue8", "red7"]},
      	],
      	},
      blue8 : {
        content : [
          ...
          choice : ["What’s the source of the claim that the government really gives more money to refugees than Canadian pensioners?", "Does the government really give more money to refugees than Canadian pensioners?"],
          goto : ["blue9", "red8"]},
          ],
        },
      red7 : {
          ...
          {source : "source_2", text : "If someone is saying they want to repeal multiculturalism would they even pass a Canadian values test?",
          choice : ["What’s the source of the claim that the government really gives more money to refugees than Canadian pensioners?", "Does the government really give more money to refugees than Canadian pensioners?"],
          goto : ["blue9", "red8"]},
      	],
      	},
      blue9 : {
        content : [
          ...
          choice : ["I’m starting to wonder who is benefitting from this news story. How can I find out more about it?", "Is this story even from a legitimate news site?"],
          goto : ["blue10", "red9"]},
          ],
        },
      red8 : {
      ...
      red9 : {
          ...
          {source : "source_2", text : "Cake! So that’s what the C in CNN stands for!",
          choice : ["Thank folks!"],
          goto : ["end"]},
      	],
      },
